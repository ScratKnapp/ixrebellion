...
PLUGIN:AddLink('Discord', 'Provides a link to the discord server.', 'https://discord.gg/rqYMrVrvr')
PLUGIN:AddLink('Content', 'Provides a link to the server content.', 'https://steamcommunity.com/sharedfiles/filedetails/?id=3047421054')